...
motorDataValues = numpy.load(file3, mmap_mode=None, allow_pickle=False, fix_imports=True, encoding='ASCII')
...
matplotlib.pyplot.plot(motorDataValues, label='targetAngles', linewidth=2.0)
